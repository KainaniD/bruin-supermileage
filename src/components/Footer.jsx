    ...
    return (
        ...
        <div className="mt-20 flex flex-col-reverse md:flex-row justify-around items-center gap-10 md:items-start w-full min-h-20 p-5 pb-20 bg-blue-900">
            ...
            <div className="flex flex-col gap-10">
                <h1 className="text-neutral-200 footer-title text-center">Contact us</h1>
                ...
                >
                    <a href="mailto:smv@bruinracing.org/" target="_blank"><FontAwesomeIcon className='text-black social-item bg-white' icon={faEnvelope} /></a>
                </motion.div>
                <motion.div
                    whileHover={{ scale: 1.5 }}
                    whileTap={{ scale: 1 }}
                    className='flex justify-center'
                >
                    <a href="https://www.instagram.com/bruinsupermileage/" target="_blank"><FontAwesomeIcon className='text-black social-item bg-white' icon={faInstagram} /></a>
                </motion.div>
                </div>
            </div>
        </div>
